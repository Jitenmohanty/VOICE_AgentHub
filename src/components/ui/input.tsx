...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        "h-11 w-full min-w-0 rounded-xl px-3.5 py-2.5 text-base",
        ...
        "file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-base file:font-medium file:text-white",
