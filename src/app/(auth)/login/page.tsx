    ...
    <AuthShell
      ...
      footer={
        <>
          ...
          <Link href="/register" className="ah-gradient-text font-medium hover:opacity-80">
            Sign up
          </Link>
        </>
      }
      ...
      <GlassPanel elevation="raised" radius="lg" className="p-8">
        <div className="flex flex-col gap-2.5 mb-6">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white text-sm hover:bg-white/[0.08] hover:border-white/20 transition-all"
          >
          ...
          <button
            type="button"
            onClick={() => signIn("github", { callbackUrl: "/business/dashboard" })}
            className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white text-sm hover:bg-white/[0.08] hover:border-white/20 transition-all"
          >
